...
insert into auth.users (id, email) values
  ('a0000000-0000-0000-0000-000000000001', 'a@test.sameway'),
  ('b0000000-0000-0000-0000-000000000002', 'b@test.sameway'),
  ('c0000000-0000-0000-0000-000000000003', 'c@test.sameway');
...
values ('d0000000-0000-0000-0000-0000000000v1', 'b0000000-0000-0000-0000-000000000002',
...
insert into public.rides (
  ...
  'e0000000-0000-0000-0000-0000000000r1', 'b0000000-0000-0000-0000-000000000002',
  'd0000000-0000-0000-0000-0000000000v1', 'Baku', 40.40, 49.86,
...
insert into public.bookings (
  ...
  'f0000000-0000-0000-0000-0000000000b1', 'e0000000-0000-0000-0000-0000000000r1',
...
insert into public.transactions (
  ...
  '10000000-0000-0000-0000-000000000t1', 'f0000000-0000-0000-0000-0000000000b1',
...
values ('20000000-0000-0000-0000-000000000c1', 'e0000000-0000-0000-0000-0000000000r1',
        'f0000000-0000-0000-0000-0000000000b1', 'booking');

insert into public.conversation_participants (conversation_id, user_id) values
  ('20000000-0000-0000-0000-000000000c1', 'a0000000-0000-0000-0000-000000000001'),
  ('20000000-0000-0000-0000-000000000c1', 'b0000000-0000-0000-0000-000000000002');

insert into public.messages (id, conversation_id, sender_id, body) values
  ('30000000-0000-0000-0000-000000000m1', '20000000-0000-0000-0000-000000000c1',
...
values ('40000000-0000-0000-0000-000000000rp', 'a0000000-0000-0000-0000-000000000001',
...
select is((select phone from public.public_profiles limit 1) is null, true,
...
select throws_ok(
  $$ insert into public.bookings (ride_id, lead_passenger_id, seat_count, total_price, payment_method, expires_at)
     values ('e0000000-0000-0000-0000-0000000000r1', 'a0000000-0000-0000-0000-000000000001', 1, 15, 'cash', now()) $$,
  null, null,
...
select throws_ok(
  $$ update public.transactions set status = 'reversed' where id = '10000000-0000-0000-0000-000000000t1' $$,
  null, null,
...
-- ------------------------------------------------------------
select pg_temp.as_user('b0000000-0000-0000-0000-000000000002');
select is((select count(*) from public.messages where conversation_id = '20000000-0000-0000-0000-000000000c1')::int, 1,
  'Participant B can read the conversation''s messages');
select pg_temp.as_user('c0000000-0000-0000-0000-000000000003');
select is((select count(*) from public.messages where conversation_id = '20000000-0000-0000-0000-000000000c1')::int, 0,
  'Non-participant C CANNOT read the conversation''s messages');
select is((select count(*) from public.conversation_participants
           where conversation_id = '20000000-0000-0000-0000-000000000c1')::int, 0,

-- ============================================================
-- 016 · RIDE INQUIRIES — pre-booking "Negocjuj" path (part 2 of 2)
--
-- Everything except the conversation_type_t enum addition, which must
-- live in its own migration (015) because a new enum value cannot be
-- referenced in the same transaction that adds it — see the comment
-- in 015_ride_inquiries.sql. Feature rationale lives there too.
-- ============================================================
